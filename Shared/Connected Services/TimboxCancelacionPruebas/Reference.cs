...
namespace TimboxCancelacionPruebas
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:WashOut", ConfigurationName="TimboxCancelacionPruebas.cancelacion_port")]
    public interface cancelacion_port
    {
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.cancelar_cfdi_result> cancelar_cfdiAsync(string username, string password, string rfc_emisor, TimboxCancelacionPruebas.folios folios, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.cancelar_cfdi_externo_result> cancelar_cfdi_externoAsync(string username, string password, string rfc_emisor, TimboxCancelacionPruebas.folios_externo folios, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.cancelar_cfdi_seguro_result> cancelar_cfdi_seguroAsync(string username, string password, string firma_base64);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.consultar_estatus_result> consultar_estatusAsync(string username, string password, string uuid, string rfc_emisor, string rfc_receptor, string total);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.consultar_peticiones_pendientes_result> consultar_peticiones_pendientesAsync(string username, string password, string rfc_receptor, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.procesar_respuesta_result> procesar_respuestaAsync(string username, string password, string rfc_receptor, TimboxCancelacionPruebas.respuestas respuestas, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionPruebas.consultar_documento_relacionado_result> consultar_documento_relacionadoAsync(string username, string password, string uuid, string rfc_emisor, string rfc_receptor, string cert_pem, string llave_pem);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface cancelacion_portChannel : TimboxCancelacionPruebas.cancelacion_port, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class cancelacion_portClient : System.ServiceModel.ClientBase<TimboxCancelacionPruebas.cancelacion_port>, TimboxCancelacionPruebas.cancelacion_port
    {
        ...
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.cancelar_cfdi_result> cancelar_cfdiAsync(string username, string password, string rfc_emisor, TimboxCancelacionPruebas.folios folios, string cert_pem, string llave_pem)
        {
            return base.Channel.cancelar_cfdiAsync(username, password, rfc_emisor, folios, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.cancelar_cfdi_externo_result> cancelar_cfdi_externoAsync(string username, string password, string rfc_emisor, TimboxCancelacionPruebas.folios_externo folios, string cert_pem, string llave_pem)
        {
            return base.Channel.cancelar_cfdi_externoAsync(username, password, rfc_emisor, folios, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.cancelar_cfdi_seguro_result> cancelar_cfdi_seguroAsync(string username, string password, string firma_base64)
        {
            return base.Channel.cancelar_cfdi_seguroAsync(username, password, firma_base64);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.consultar_estatus_result> consultar_estatusAsync(string username, string password, string uuid, string rfc_emisor, string rfc_receptor, string total)
        {
            return base.Channel.consultar_estatusAsync(username, password, uuid, rfc_emisor, rfc_receptor, total);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.consultar_peticiones_pendientes_result> consultar_peticiones_pendientesAsync(string username, string password, string rfc_receptor, string cert_pem, string llave_pem)
        {
            return base.Channel.consultar_peticiones_pendientesAsync(username, password, rfc_receptor, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.procesar_respuesta_result> procesar_respuestaAsync(string username, string password, string rfc_receptor, TimboxCancelacionPruebas.respuestas respuestas, string cert_pem, string llave_pem)
        {
            return base.Channel.procesar_respuestaAsync(username, password, rfc_receptor, respuestas, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionPruebas.consultar_documento_relacionado_result> consultar_documento_relacionadoAsync(string username, string password, string uuid, string rfc_emisor, string rfc_receptor, string cert_pem, string llave_pem)
        {
