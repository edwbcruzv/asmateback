...
{
    public class CreateAhorroVoluntarioCommandValidator : AbstractValidator<CreateAhorroVoluntarioCommand>
    {
        ...
        public CreateAhorroVoluntarioCommandValidator(IRepositoryAsync<Company> repositoryAsyncCompany, IRepositoryAsync<Employee> repositoryAsyncEmployee)
        {
