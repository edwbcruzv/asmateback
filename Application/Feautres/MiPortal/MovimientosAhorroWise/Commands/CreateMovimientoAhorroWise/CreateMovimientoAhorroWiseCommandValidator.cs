...
{
    public class CreateMovimientoAhorroWiseCommandValidator : AbstractValidator<CreateMovimientoAhorroWiseCommand>
    {
        ...
        public CreateMovimientoAhorroWiseCommandValidator(IRepositoryAsync<Company> repositoryAsyncCompany, IRepositoryAsync<Employee> repositoryAsyncEmployee, IRepositoryAsync<AhorroWise> repositoryAsyncAhorroWise)
        {
