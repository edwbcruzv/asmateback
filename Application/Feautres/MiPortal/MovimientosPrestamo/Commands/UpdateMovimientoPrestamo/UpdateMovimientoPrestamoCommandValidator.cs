...
{
    public class UpdateMovimientoPrestamoCommandValidator : AbstractValidator<UpdateMovimientoPrestamoCommand>
    {
        ...
        public UpdateMovimientoPrestamoCommandValidator(IRepositoryAsync<Company> repositoryAsyncCompany, IRepositoryAsync<Employee> repositoryAsyncEmployee, IRepositoryAsync<Prestamo> repositoryAsyncPrestamo)
        {
