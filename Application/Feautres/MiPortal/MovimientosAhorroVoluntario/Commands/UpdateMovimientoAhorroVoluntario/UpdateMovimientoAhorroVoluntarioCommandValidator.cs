...
{
    public class UpdateMovimientoAhorroVoluntarioCommandValidator : AbstractValidator<UpdateMovimientoAhorroVoluntarioCommand>
    {
        ...
        public UpdateMovimientoAhorroVoluntarioCommandValidator(IRepositoryAsync<Company> repositoryAsyncCompany, IRepositoryAsync<Employee> repositoryAsyncEmployee, IRepositoryAsync<AhorroVoluntario> repositoryAsyncAhorrovoluntario)
        {
