...
{
    public class UpdatePrestamoCommandValidator : AbstractValidator<UpdatePrestamoCommand>
    {
        ...
        public UpdatePrestamoCommandValidator(IRepositoryAsync<Company> repositoryAsyncCompany, IRepositoryAsync<Employee> repositoryAsyncEmployee)
        {
            ...
            RuleFor(x => x.FechaFinal)
                .NotEmpty().WithMessage("La fecha final es obligatorio");

            RuleFor(x => x.PeriodoInicial)
                .NotEmpty().WithMessage("el periodo inicial es obligatorio");

            RuleFor(x => x.PeriodoFinal)
                .NotEmpty().WithMessage("El periodo final es obligatorio");
