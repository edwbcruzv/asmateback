...
{
    public class UpdatePrestamoAcuseCommand: IRequest<Response<string>>
    {
        public int Id { get; set; }
        public IFormFile FileAcuseFirmado { get; set; }


         public class Handler : IRequestHandler<UpdatePrestamoAcuseCommand, Response<string>>
        {
            ...
            public async Task<Response<string>> Handle(UpdatePrestamoAcuseCommand request, CancellationToken cancellationToken)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        if (string.IsNullOrEmpty( prestamo.SrcDocAcuseFirmado))
                        {
                            prestamo.SrcDocAcuseFirmado = _prestamoService.SaveAcuseFirmadoPDF(request.FileAcuseFirmado, prestamo.Id);
                        }
                        else
                        {
                    ...
                    return new Response<string>(dto.SrcDocAcuseFirmado, null);
                }
