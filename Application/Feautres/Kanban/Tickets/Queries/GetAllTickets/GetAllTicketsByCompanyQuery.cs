...
{
    public class GetAllTicketsByCompanyQuery : IRequest<Response<List<TicketDTO>>>
    {

        public int CompanyId { get; set; }

        public class Handler : IRequestHandler<GetAllTicketsByCompanyQuery, Response<List<TicketDTO>>>
        {
            ...
            public async Task<Response<List<TicketDTO>>> Handle(GetAllTicketsByCompanyQuery request, CancellationToken cancellationToken)
            {
                var list_ticket = await _repositoryAsync.ListAsync(new TicketByCompanyIdSpecification(request.CompanyId));
