...
{
    public class UpdateFacturaCommandValidator : AbstractValidator<UpdateFacturaCommand>
    {
        ...
        public UpdateFacturaCommandValidator(IRepositoryAsync<Company> repositoryAsync, IRepositoryAsync<UsoCfdi> repositoryAsyncUsoCfdi,
