...
{
    public class CreateFacturaMovimientoCommandValidator : AbstractValidator<CreateFacturaMovimientoCommand>
    {
        ...
        public CreateFacturaMovimientoCommandValidator(IRepositoryAsync<Factura> repositoryAsyncFactura,
