...
{
    public class CreateComplementoPagoFacturaCommandValidator : AbstractValidator<CreateComplementoPagoFacturaCommand>
    {
        ...
        public CreateComplementoPagoFacturaCommandValidator(
