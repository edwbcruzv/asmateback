...
namespace Persistence.Migrations
{
    ...
    [Migration("20240410234602_columnascomprobantes")]
    partial class columnascomprobantes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AhorroVoluntario", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaEstatusActivo")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FechaEstatusFiniquitado")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("FechaEstatusPendiente")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FechaEstatusRechazado")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SrcCartaFirmada")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SrcDocContanciaTransferencia")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Comprobante", b =>
                {
                    ...
                    b.Property<int>("TipoComprobantes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Prestamo", b =>
                {
                    ...
                    b.Property<string>("SrcDocAcuseFirmado")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SrcDocConstanciaRetiro")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SrcDocContanciaTransferencia")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SrcDocPagare")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.RetiroAhorroVoluntario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("FechaEstatusAutorizado")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("SeguirAhorrando")
                        .HasColumnType("bit");

                    b.Property<string>("SrcDocContanciaPago")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SrcDocContanciaTransferencia")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SrcDocSolicitudFirmado")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id", "AhorroVoluntarioId");

                    b.HasIndex("AhorroVoluntarioId");

                    b.ToTable("RetirosAhorroVoluntario");
                });
