...
namespace Persistence.Migrations
{
    ...
    [Migration("20230712173059_AgregandoReembolsos")]
    partial class AgregandoReembolsos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.MovimientoReembolso", b =>
                {
                    ...
                    b.Property<int>("LugarExpedicion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Reembolso", b =>
                {
                    ...
                    b.Property<string>("SrcPdfFichaPago")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("UsuarioIdPagado")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.TipoArchivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.MovimientoReembolso", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TipoArchivo", "TipoArchivo")
                        .WithMany("MovimientosReembolso")
                        .HasForeignKey("TipoArchivoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_id_tipoarchivo_movreembolso");
